...
plot(sort(procrustes_var$range[, "radius"], decreasing = TRUE), type = "l", ylim = c(0, 0.1),
     xlab = "ranked landmarks", ylab = "landmark difference", main = "Variation range ranking")
lines(sort(var_range_95$range[, "radius"], decreasing = TRUE), col = "orange")
lines(sort(var_range_75$range[, "radius"], decreasing = TRUE), col = "blue")
lines(sort(var_range_50$range[, "radius"], decreasing = TRUE), col = "darkgreen")
legend("topright", bty = "n", lty = 1, col = c("black", "orange", "blue", "darkgreen"), 
       legend = c("100% CI", "95% CI", "75% CI", "50% CI"))
```
