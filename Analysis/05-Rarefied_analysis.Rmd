...
```{r, eval = TRUE, echo = FALSE, print = FALSE, results = 'hide'}
make.plots(results$differences, type = "area difference", add.p = TRUE, correction = "bonferroni", path = paste0("../Manuscript/Figures/", species, "_", dataset, "_difference_rarefied.pdf"))
make.plots(results$overlaps, type = "Bhattacharyya Coefficient", add.p = TRUE, correction = "bonferroni", path = paste0("../Manuscript/Figures/", species, "_", dataset, "_overlaps_rarefied.pdf"))
```
