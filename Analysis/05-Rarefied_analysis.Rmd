...
#results <- pipeline.test(species, dataset, "../Data/Processed/", verbose = TRUE, rarefaction = TRUE)
#save(results, file = paste0("../Data/Results/", species, "_", dataset, "rarefied.Rda"))
load(paste0("../Data/Results/", species, "_", dataset, "rarefied.Rda"))
...
## xtables for pub
make.xtable(results$differences, "bonferroni", digits = 3, caption = caption_diff, path = "../Manuscript/Tables/", label = paste0(species, "_", dataset, "_difference_rarefied"))
make.xtable(results$overlaps, "bonferroni", digits = 3, caption = caption_over, path = "../Manuscript/Tables/", label = paste0(species, "_", dataset, "_overlaps_rarefied"))
```
...
```{r, eval = TRUE, echo = FALSE, print = FALSE, results = 'hide'}
make.plots(results$differences, type = "area difference", add.p = TRUE, correction = "bonferroni", rarefaction = TRUE, rare.level = results$rarefaction, path = paste0("../Manuscript/Figures/", species, "_", dataset, "_difference_rarefied.pdf"))
make.plots(results$overlaps, type = "Bhattacharyya Coefficient", add.p = TRUE, correction = "bonferroni", rarefaction = TRUE, rare.level = results$rarefaction, path = paste0("../Manuscript/Figures/", species, "_", dataset, "_overlaps_rarefied.pdf"))
```
