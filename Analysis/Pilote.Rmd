...
ClassifierCr <- read.csv("../Data/ClassificationWomCr.csv", header = TRUE)
## The landmarks list
landmarks <- read.csv("../Data/MovingLMs.csv")
#VW: Read data
WomCrData <- read.csv("../Data/Wombat_Cranium_Lndmrk_Data.csv", header = TRUE, row.names = 1)
