...
dataset <- "cranium"
#results <- pipeline.test(species, dataset, "../Data/Processed/", verbose = TRUE, combine.land = FALSE, CI = 0.95)
...
## xtables for pub
make.xtable(results$differences, "bonferroni", digits = 3, caption = caption_diff, path = "../Manuscript/Tables/", label = paste0(species, "_", dataset, "_difference_CI95"))
make.xtable(results$overlaps, "bonferroni", digits = 3, caption = caption_over, path = "../Manuscript/Tables/", label = paste0(species, "_", dataset, "_overlaps_CI95"))
```
