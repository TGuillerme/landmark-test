...
Search and replace `CI = 1` and `CI100` by respectively `CI = 1` and `CI100` for switching from the 95% confidence interval to the 100%.
...
species <- "Wombat"
dataset <- "cranium"
results <- pipeline.test(species, dataset, "../Data/Processed/", verbose = TRUE, combine.land = FALSE, CI = 1, use.PC.range = TRUE)
save(results, file = paste0("../Data/Results/", species, "_", dataset, "_CI100_PC1.Rda"))
load(file = paste0("../Data/Results/", species, "_", dataset, "_CI100_PC1.Rda"))
...
```{r, eval = TRUE, echo = FALSE, print = FALSE, results = 'hide'}
make.plots(results$differences, type = "area difference", add.p = TRUE, correction = "bonferroni", path = paste0("../Manuscript/Figures/", species, "_", dataset, "_difference_CI100_PC1.pdf"))
make.plots(results$overlaps, type = "Bhattacharyya Coefficient", add.p = TRUE, correction = "bonferroni", path = paste0("../Manuscript/Figures/", species, "_", dataset, "_overlaps_CI100_PC1.pdf"))
```
...
save(results, file = paste0("../Data/Results/", species, "_", dataset, "rarefied_CI100_PC1.Rda"))
load(paste0("../Data/Results/", species, "_", dataset, "rarefied_CI100_PC1.Rda"))
...
```{r, eval = TRUE, echo = FALSE, print = FALSE, results = 'hide'}
make.plots(results$differences, type = "area difference", add.p = TRUE, correction = "bonferroni", rarefaction = TRUE, rare.level = results$rarefaction, path = paste0("../Manuscript/Figures/", species, "_", dataset, "_difference_rarefied_CI100_PC1.pdf"))
make.plots(results$overlaps, type = "Bhattacharyya Coefficient", add.p = TRUE, correction = "bonferroni", rarefaction = TRUE, rare.level = results$rarefaction, path = paste0("../Manuscript/Figures/", species, "_", dataset, "_overlaps_rarefied_CI100_PC1.pdf"))
```
