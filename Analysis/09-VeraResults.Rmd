...
allom.shape(land_data$mandible$procrustes)
...
```{r}
#I want to later make this a function for "Full_Classifier_Table"
Full_Classifier_Table=read.csv("../Data/Raw/classifier_cranium_wombat.csv")
...
sp_holders <- c("Common wombat", "SHN wombat", "NHN wombat")
    ...
    Class=Full_Classifier_Table[Full_Classifier_Table$Species==sp_holders[i],]
    NAME (SUBSET)<-SPECIES[i]#HOW DO I NAME THE OUTPUT APPROPRIATELY SO i END UP WITH 3 SUBSETTED DATASETS?
    }
