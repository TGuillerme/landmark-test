...
procD.lm(coords~Temp,data=Geo_GDFs$CW$cranium, iter=1000 )#WOOOOOOOOOORKS!!
...
#Geolocation
coords=coords_Geo_output$SHNW$cranium
Aridity=SHNW_cranium_Class$Aridity[!is.na(SHNW_cranium_Class$Aridity)]
Temp=SHNW_cranium_Class$Temperature[!is.na(SHNW_cranium_Class$Temperature)]
procD.lm(coords~Aridity)
procD.lm(coords~Temp)
