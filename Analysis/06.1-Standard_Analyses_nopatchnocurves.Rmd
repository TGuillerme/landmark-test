...
##brief check that the landmarks were pulled out correctly - number of landmarks and plotting of landmarks
 ...
 length(dimnames(mshape(AllWombats$cranium$procrustes_no_patches_no_curves$coords))[[1]]); plot3d(mshape(AllWombats$cranium$procrustes_no_patches_no_curves$coords),asp=FALSE)
  
 length( dimnames(mshape(AllWombats$mandible$procrustes_no_patches_no_curves$coords))[[1]])
 plot3d(mshape(AllWombats$mandible$procrustes_no_patches_no_curves$coords),asp=FALSE)
  
   ### fixed landmarks only: 261 curve landmarks for cranium, 142 fixed landmarks for mandible
  length(dimnames(mshape(AllWombats$cranium$procrustes_no_patches$coords))[[1]])-65; plot3d(mshape(AllWombats$cranium$procrustes_no_patches$coords),asp=FALSE)
  
 length( dimnames(mshape(AllWombats$mandible$procrustes_no_patches$coords))[[1]])-35;
...
plotTangentSpace(NHNW$cranium$procrustes_no_patches_no_curves$coords)
plotTangentSpace(NHNW$mandible$procrustes_no_patches_no_curves$coords)

plotTangentSpace(SHNW$cranium$procrustes_no_patches_no_curves$coords)
plotTangentSpace(SHNW$mandible$procrustes_no_patches_no_curves$coords)

plotTangentSpace(CW$cranium$procrustes_no_patches_no_curves$coords)
plotTangentSpace(CW$mandible$procrustes_no_patches_no_curves$coords)
...
cranium_gdf  <- geomorph.data.frame(coords = AllWombats$cranium$procrustes_no_patches_no_curves$coords,
                                    Csize = AllWombats$cranium$procrustes_no_patches_no_curves$Csize,
                                    species = as.factor(cranium$Species))
mandible_gdf <- geomorph.data.frame(coords = AllWombats$mandible$procrustes_no_patches_no_curves$coords,
                                    Csize = AllWombats$mandible$procrustes_no_patches_no_curves$Csize,
...
for (i in 1:length(all_data)){
    ...
    for (k in 1:length(all_classifiers[[i]])){
        ...
        ## Sex coordinates
        coords_sex_output[[i]][[k]] <- all_data[[i]][[k]]$procrustes_no_patches_no_curves$coords[,,
                                       !is.na(all_classifiers[[i]][[k]]$Sex)]
        ## Sex centroid size
        c_size_sex_output[[i]][[k]] <- all_data[[i]][[k]]$procrustes_no_patches_no_curves$Csize[
                                       !is.na(all_classifiers[[i]][[k]]$Sex)]
...
for (i in 1:length(all_data)){
    for (k in 1:length(all_data[[1]])){
        ...
        allom_output[[i]][[k]] <- handle.procD.formula(coords ~ Csize,
                                                 all_data[[i]][[k]]$procrustes_no_patches_no_curves,
...
##turn into gdf frame 
gdf_cranium <- geomorph.data.frame(coords = AllWombats$cranium$procrustes_no_patches_no_curves$coords, 
                           Csize = AllWombats$cranium$procrustes_no_patches_no_curves$Csize)
...
##turn into gdf frame 
gdf_mandible <- geomorph.data.frame(coords = AllWombats$mandible$procrustes_no_patches_no_curves$coords,
                           Csize = AllWombats$mandible$procrustes_no_patches_no_curves$Csize)
...
matched_coords <- reduce.check(all_data, all_classifiers, procrustes=5)
```
...
for (i in 1:length(all_data)){
  ...
  for (k in 1:length(all_data$NHNW)){
    ...
    centroid_size[[i]][[k]] <- as.data.frame(all_data[[i]][[k]]$procrustes_no_patches_no_curves$Csize)  
