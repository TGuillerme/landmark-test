...
ylabs <- c(expression(paste(italic("Lasiorhinus vs. Vombatus"), " GPA means")),
            expression(paste("Between ", italic("Lasiorhinus"), " GPA means")),
            expression(paste("Within ", italic("Lasiorhinus krefftii"), "(100% GPA)")),
            expression(paste("Within ", italic("Lasiorhinus krefftii"), "(95% GPA)")),
            expression(paste("Within ", italic("Lasiorhinus latifrons"), "(100% GPA)")),
            expression(paste("Within ", italic("Lasiorhinus latifrons"), "(95% GPA)")),
            expression(paste("Within ", italic("Vombatus ursinus"), "(100% GPA)")),
            expression(paste("Within ", italic("Vombatus ursinus"), "(95% GPA)")))
...
```{r, echo = FALSE}
pdf(file = "../Manuscript/Figures/landmark_test_results_full.pdf", width = 11.5, height = 4.5)
