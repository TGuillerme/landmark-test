...
results_table_100 <- summarise.results(CI = 100, rarefaction = FALSE, print.token = TRUE)
results_table_95 <- summarise.results(CI = 95, rarefaction = FALSE, print.token = TRUE)
...
```{r, echo = TRUE}
## Summarising the results
results_table_rar_100 <- summarise.results(CI = 100, rarefaction = TRUE, print.token = TRUE)
results_table_rar_95 <- summarise.results(CI = 95, rarefaction = TRUE, print.token = TRUE)
