...
ylabs <- c("All species", expression(italic("Lasiorhinus")), expression(italic("Lasiorhinus krefftii")), expression(italic("Lasiorhinus latifrons")), expression(italic("Vombatus ursinus")))
```

### Results for the full dataset

```{r,  fig.width = 10, fig.height = 6}
plot.test.results(data_100, rare_100, no.rar = c(2,5), xlabs = xlabs, ylabs = ylabs)
```

```{r, echo= FALSE}
## Saving the table
pdf(file = "../Manuscript/Figures/landmark_test_results_100.pdf", width = 7.2, height = 4.5)
plot.test.results(data_100, rare_100, no.rar = c(2,5), xlabs = xlabs, ylabs = ylabs)
dev.off()
```
...
```{r,  fig.width = 10, fig.height = 6}
plot.test.results(data_95, rare_95, no.rar = c(2,5), xlabs = xlabs, ylabs = ylabs)
```

```{r, echo= FALSE}
## Saving the table
pdf(file = "../Manuscript/Figures/landmark_test_results_95.pdf", width = 7.2, height = 4.5)
plot.test.results(data_95, rare_95, no.rar = c(2,5), xlabs = xlabs, ylabs = ylabs)
dev.off()
```
