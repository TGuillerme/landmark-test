...
## Thee GPA for the cranium and mandible for the Lasiorhinus
...
differences_list_cran <- list(
    "vomba_lasio" = coordinates.difference(type = "spherical",
                        all_means_cran$Vombatus_ursinus, all_means_cran$Lasiorhinus),
    "latif_kreft" = coordinates.difference(type = "spherical",
                        las_means_cran$Lasiorhinus_latifrons, las_means_cran$Lasiorhinus_krefftii))
differences_list_mand <- list(
    "vomba_lasio" = coordinates.difference(type = "spherical",
                        all_means_mand$Vombatus_ursinus, all_means_mand$Lasiorhinus),
    "latif_kreft" = coordinates.difference(type = "spherical",
                        las_means_mand$Lasiorhinus_latifrons, las_means_mand$Lasiorhinus_krefftii))
...
save(group_cranium, file = paste0(save_path, "Group_cranium_means.Rda"))
save(group_mandible, file = paste0(save_path, "Group_mandible_means.Rda"))
...
## Saving the test results
save(group_cranium, file = paste0(save_path, "Group_craniumrarefied_means.Rda"))
save(group_mandible, file = paste0(save_path, "Group_mandiblerarefied_means.Rda"))
```
