...
mean_results_obs <- summarise.results(CI = "mean", rarefaction = FALSE, rounding = 4, result.type = "pc1.hypothetical")
mean_results_rar <- summarise.results(CI = "mean", rarefaction = TRUE, rounding = 4, result.type = "pc1.hypothetical")

## Loading the extreme results (observed)
species_results_100_obs <- summarise.results(CI = 100, rarefaction = FALSE, rounding = 4, result.type = "pc1.hypothetical")
species_results_095_obs <- summarise.results(CI = 95, rarefaction = FALSE, rounding = 4, result.type = "pc1.hypothetical")
species_results_100_rar <- summarise.results(CI = 100, rarefaction = TRUE, rounding = 4, result.type = "pc1.hypothetical")
species_results_095_rar <- summarise.results(CI = 95, rarefaction = TRUE, rounding = 4, result.type = "pc1.hypothetical")
```
...
ylabs <- c(expression(paste(italic("Lasiorhinus vs. Vombatus"), " hyp. means")),
            expression(paste("Between ", italic("Lasiorhinus"), " hyp. means")),
            expression(paste("Within ", italic("Lasiorhinus krefftii"), "(100% hyp.)")),
            expression(paste("Within ", italic("Lasiorhinus krefftii"), "(95% hyp.)")),
            expression(paste("Within ", italic("Lasiorhinus latifrons"), "(100% hyp.)")),
            expression(paste("Within ", italic("Lasiorhinus latifrons"), "(95% hyp.)")),
            expression(paste("Within ", italic("Vombatus ursinus"), "(100% hyp.)")),
            expression(paste("Within ", italic("Vombatus ursinus"), "(95% hyp.)")))

plot.test.results(complete_results_obs, complete_results_rar, p.value = 0.001,
                  no.rar = c(2,5), xlabs = xlabs, ylabs = ylabs, digits = 3, left.pad = 16)
```

```{r, echo = FALSE}
pdf(file = "../Manuscript/Figures/landmark_test_results_full_PC1_hypothetical.pdf", width = 11.5, height = 4.5)
plot.test.results(complete_results_obs, complete_results_rar, p.value = 0.001, no.rar = c(2,5), xlabs = xlabs, ylabs = ylabs, digits = 3, left.pad = 16)
dev.off()
```
