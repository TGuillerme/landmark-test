...
mean_results_obs <- summarise.results(CI = "mean", rarefaction = FALSE, rounding = 4, result.type = "pc1.extremes")
mean_results_rar <- summarise.results(CI = "mean", rarefaction = TRUE, rounding = 4, result.type = "pc1.extremes")

## Loading the extreme results (observed)
species_results_100_obs <- summarise.results(CI = 100, rarefaction = FALSE, rounding = 4, result.type = "pc1.extremes")
species_results_095_obs <- summarise.results(CI = 95, rarefaction = FALSE, rounding = 4, result.type = "pc1.extremes")
species_results_100_rar <- summarise.results(CI = 100, rarefaction = TRUE, rounding = 4, result.type = "pc1.extremes")
species_results_095_rar <- summarise.results(CI = 95, rarefaction = TRUE, rounding = 4, result.type = "pc1.extremes")
```
...
ylabs <- c(expression(paste(italic("Lasiorhinus vs. Vombatus"), " PC1 means")),
            expression(paste("Between ", italic("Lasiorhinus"), " PC1 means")),
            expression(paste("Within ", italic("Lasiorhinus krefftii"), "(100% PC1)")),
            expression(paste("Within ", italic("Lasiorhinus krefftii"), "(95% PC1)")),
            expression(paste("Within ", italic("Lasiorhinus latifrons"), "(100% PC1)")),
            expression(paste("Within ", italic("Lasiorhinus latifrons"), "(95% PC1)")),
            expression(paste("Within ", italic("Vombatus ursinus"), "(100% PC1)")),
            expression(paste("Within ", italic("Vombatus ursinus"), "(95% PC1)")))
...
```{r, echo = FALSE}
pdf(file = "../Manuscript/Figures/landmark_test_results_full_PC1_extremes.pdf", width = 11.5, height = 4.5)
