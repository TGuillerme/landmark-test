...
WomMaPC1Scores <- land_data$mandible$ordination$x[,1]
WomMaPC2Scores <- land_data$mandible$ordination$x[,2]
WomMaPC <- data.frame(WomMaPC1Scores, WomMaPC2Scores)
...
ggplot(WomCrPC, aes(x=WomCrPC$WomCrPC1Scores, y=WomCrPC$WomCrPC2Scores, colour=Species, fill=Species))+
