...
load("../Data/Processed/wombat.Rda")
classifier_cranium <- read.csv("../Data/Raw/classifier_cranium_wombat.csv")
classifier_mandible <- read.csv("../Data/Raw/classifier_mandible_wombat.csv")
...
Allom=procD.allometry(coords~Csize, data=gdf, method="RegScore")


plot(Allom, method="RegScore", pt.col=mandible$Species, label=mandible$ID)
