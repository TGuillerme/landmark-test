...
# PCA plot for Figure 1 and supplementary Figure 4
...
pdf("../Manuscript/Figures/suppfigure2_PCA.pdf", height = 10, width = 12)
#plot.new()
par(mfrow = c(2,2))
plot.pca(land_data$cranium$ordination, classifier_cranium$Species);legend("bottomleft", c("Common", "Southern HN", "Northern HN"), pt.bg=(gg.color.hue(3)),pch=21, bty="n", cex=1.2 ); legend ("top", "All Species - Cranium", bty="n", cex=1.2)
