...
par(mfrow = c(2,2))
plot.pca(land_data$cranium$ordination, classifier_cranium$Species);legend("bottomleft", c("Common", "Southern HN", "Northern HN"), pt.bg=(gg.color.hue(3)),pch=21, bty="n", cex=1.2, y.intersp = 0.7 ); legend ("top", "All Species - Cranium", bty="n", cex=1.2)
plot.pca(land_data$mandible$ordination, classifier_mandible$Species); legend ("top", "All Species - Mandible", bty="n", cex=1.2)
...
plot.pca(HN$cranium$ordination, classifier_cranium_Lasio$Species);  legend ("top", "Hairy-nosed - Cranium", bty="n", cex=1.2)
plot.pca(HN$mandible$ordination, classifier_mandible_Lasio$Species);  legend ("top", "Hairy-nosed - Mandible", bty="n", cex=1.2)
...
#plot.new()
par(mfrow = c(2,2))
plot.pca(ordination_cran, classifier_cranium$Species);legend("bottomleft", c("Common", "Southern HN", "Northern HN"), pt.bg=(gg.color.hue(3)),pch=21, bty="n", cex=1.2 ); legend ("top", "All Species - Cranium", bty="n", cex=1.2)

plot.pca(ordination_mand, classifier_mandible$Species); legend ("top", "All Species - Mandible", bty="n", cex=1.2)
...
plot.pca(ordination_cran_las, classifier_cranium_Lasio$Species);  legend ("top", "Hairy-nosed - Cranium", bty="n", cex=1.2)
plot.pca(ordination_mand_las, classifier_mandible_Lasio$Species);  legend ("top", "Hairy-nosed - Mandible", bty="n", cex=1.2 )
