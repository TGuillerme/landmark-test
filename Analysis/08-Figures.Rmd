...
par(mfrow = c(2,2))
plot.pca(land_data$cranium$ordination, classifier_cranium$Species, cex.axis=1.2  );legend("bottomleft", c("Common", "Southern HN", "Northern HN"), pt.bg=(gg.color.hue(3)),pch=21, bty="n", cex=1.2, y.intersp = 0.7 ); legend ("top", "All Species - Cranium", bty="n", cex=1.5)
plot.pca(land_data$mandible$ordination, classifier_mandible$Species,cex.axis=1.2 ); legend ("top", "All Species - Mandible", bty="n", cex=1.2)
...
plot.pca(HN$cranium$ordination, classifier_cranium_Lasio$Species, cex.axis=1.2 );  legend ("top", "Hairy-nosed - Cranium", bty="n", cex=1.2)
plot.pca(HN$mandible$ordination, classifier_mandible_Lasio$Species, cex.axis=1.2 );  legend ("top", "Hairy-nosed - Mandible", bty="n", cex=1.5)
...
#plot.new()
par(mfrow = c(2,2))
plot.pca(ordination_cran, classifier_cranium$Species, cex.axis=1.2 );legend("bottomleft", c("Common", "Southern HN", "Northern HN"), pt.bg=(gg.color.hue(3)),pch=21, bty="n", cex=1.2 ); legend ("top", "All Species - Cranium", bty="n", cex=1.2)

plot.pca(ordination_mand, classifier_mandible$Species, cex.axis=1.2); legend ("top", "All Species - Mandible", bty="n", cex=1.2)
...
plot.pca(ordination_cran_las, classifier_cranium_Lasio$Species, cex.axis=1.2);  legend ("top", "Hairy-nosed - Cranium", bty="n", cex=1.2)
plot.pca(ordination_mand_las, classifier_mandible_Lasio$Species, cex.axis=1.2);  legend ("top", "Hairy-nosed - Mandible", bty="n", cex=1.2 )
...
AllomCranium=procD.lm(coords~Csize, data=cranium_gdf, method="RegScore", logsz=)


mandible_gdf=geomorph.data.frame(coords=land_data$mandible$procrustes$coords, Csize=land_data$mandible$procrustes$Csize)
AllomMandible=procD.lm(coords~Csize, data=mandible_gdf, method="RegScore")
...
par(mfrow = c(1,2)) 
plotAllometry(AllomCranium, size=cranium_gdf$Csize, method="RegScore", col = gg.color.hue (length(levels(cranium$Species))) [cranium$Species], pch=19, cex=1.5, logsz = FALSE);legend ("topleft", "Cranium", bty="n", cex=1.2);legend("bottomright", c("Common", "Southern HN", "Northern HN"), pt.bg=(gg.color.hue(3)),pch=21, bty="n", cex=1.2 )
plotAllometry(AllomMandible, size=mandible_gdf$Csize, method="RegScore", col = gg.color.hue (length(levels(mandible$Species))) [mandible$Species], pch=19, cex=1.5, logsz = FALSE);legend ("topleft", "Mandible", bty="n", cex=1.2);legend("bottomright", c("Common", "Southern HN", "Northern HN"), pt.bg=(gg.color.hue(3)),pch=21, bty="n", cex=1.2 )
