...
pdf("../Manuscript/Figures/PCA_figure1.pdf", height = 6, width = 12)
#plot.new()
par(mfrow = c(1,2))
plot.pca(land_data$cranium$ordination, classifier_cranium$Species);legend("bottomleft", c("Common", "Southern HN", "Northern HN"), pt.bg=(gg.color.hue(3)),pch=21, bty="n" )
plot.pca(land_data$mandible$ordination, classifier_mandible$Species);legend("bottomleft", c("Common", "Southern HN", "Northern HN"), pt.bg=(gg.color.hue(3)),pch=21, bty="n" )

dev.off()

## PCA plots - Supplementary Fig. 4
...
pdf("../Manuscript/Figures/PCA_figure4.pdf", height = 6, width = 12)
#plot.new()
par(mfrow = c(1,2))
plot.pca(HN$cranium$ordination, classifier_cranium_Lasio$Species)
plot.pca(HN$mandible$ordination, classifier_mandible_Lasio$Species)
