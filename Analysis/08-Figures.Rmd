...
#plot.new()
par(mfrow = c(2,2))
plot.pca(land_data$cranium$ordination, classifier_cranium$Species);legend("bottomleft", c("Common", "Southern HN", "Northern HN"), pt.bg=(gg.color.hue(3)),pch=21, bty="n", cex=1.4 )
plot.pca(land_data$mandible$ordination, classifier_mandible$Species)
