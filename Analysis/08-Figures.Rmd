...
gg.color.hue(length(levels(cranium$Species)))[cranium$Species]

plot(AllomCranium, method="RegScore", 
pt.col=gg.color.hue(length(levels(cranium$Species)))[cranium$Species])

plot(AllomMandible, method="RegScore",
pt.col=gg.color.hue(length(levels(mandible$Species)))[mandible$Species])
