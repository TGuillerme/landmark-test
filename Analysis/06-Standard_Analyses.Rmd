...
Allom_plus_consensus <- allom_cranium + array(cranium_consensus, dim(allom_cranium))
...
Allom_plus_consensus <- allom_mandible + array(mandible_consensus, dim(allom_mandible))
