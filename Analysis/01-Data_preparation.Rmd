...
for(chain in chains) {
    ...
    for(dataset in datasets) {
        ...
        ## Read the curve and surfslide files
        curveslide<-read.csv(paste0("../Data/Raw/curveslide_", dataset, "_", chain, ".csv"))
        surfslide<-read.csv(paste0("../Data/Raw/surfslide_", dataset, "_", chain, ".csv"))

        ## Running the Procrustes superimposition
        land_data[[dataset]][[2]] <- geomorph::gpagen(landmarks,curves=curveslide, surfaces=surfslide$x, print.progress = TRUE)
