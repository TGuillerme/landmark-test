...
The "maximum" and "minimum" specimen in procrustes space, for example within Common HN wombats:
...
Specimens along PC extremes (i.e. not hypothetical specimens)
```{r}

##  variation ranges
cranium=CW$cranium
variation <- variation.range(cranium$procrustes$coords, ordination= "TRUE")
...
#Doing this using hypothetical PC min/max landmarks for the figures in the manuscript. See utilities file for details. 
