...
xlabs <- c("Zygomatic Arch", "Tip of snout", "Remainder", "Masticatory\nmuscle insertions",
           "Symphyseal\narea", "Remainder")
ylabs <- c(
            expression(paste( italic("L. krefftii"), "(100% CI)")),
            expression(paste("95% CI")),
            expression(paste( italic("L. latifrons"), "(100% CI)")),
            expression(paste("95% CI")),
            expression(paste( italic("V. ursinus"), "(100% CI)")),
            expression(paste("95% CI")),
            expression(paste( italic("L. krefftii"), "(100% CI)")),
            expression(paste("95% CI")),
            expression(paste( italic("L. latifrons"), "(100% CI)")),
...
plot.test.results(data = complete_results_obs, rarefaction = complete_results_rar, p.value = 0.001,
                  ...
                  left.pad = 16, ylab.cex = 1.1, hypothesis = c(1,1,-1,1,1,-1), col.hypo = "blue")
```

```{r, echo = FALSE}
pdf(file = "../Manuscript/Figures/landmark_test_results_full.pdf", width = 12, height = 8)
plot.test.results(data = complete_results_obs, rarefaction = complete_results_rar, p.value = 0.001,
                  no.rar = c(2,5), xlabs = xlabs, ylabs = ylabs, ylab2 = ylabs2, digits = 3,
                  left.pad = 16, ylab.cex = 1.1, hypothesis = c(1,1,-1,1,1,-1))
dev.off()
```
